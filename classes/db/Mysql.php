...
class MySql extends DB
{
    ...
    public function __construct($data)
    {
        ...
        $this->connection = new \mysqli($data['host'], $data['user'], $data['password'], $data['dbname'], $data['port'],
          $data['socket']);

        if ($this->connection->connect_error) {
            throw new DBException("Errore di connessione al server MySql: " . $this->connection->connect_error, '',
